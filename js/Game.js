// main game function
// this game use tridant library
function Game() {
	if ( !(this instanceof arguments.callee) ) {
        return new arguments.callee(arguments); 
    }
	// Create an install of game class call self. 
	// self Simillar to self in Objective-C 
	var self = this;
	self.gameLoop = null;
	...
	self.drawGameText = function() {
		...
		ctx.fillText("Repeat Me :)", 250,250);
		ctx.fillText("Level " + self.currentRound, 250,300);
	}
